...
![](https://static001.geekbang.org/resource/image/9e/6e/9e37d3d49b58130af046f02b1208fb6e.png?wh=3180x1730 "这段代码展示了 Claude Code 生成的父 pom.xml 核心部分（模块声明、版本管理、Spring Boot 父依赖）")
